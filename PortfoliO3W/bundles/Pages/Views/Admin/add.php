...
<form action="<?php app_info( 'url' ); ?>page/adding/" class="form" enctype="multipart/form-data" method="post">
    <fieldset class="fieldset">
        <legend class="legend"><?php echo _( 'Page' ); ?></legend>

        <div class="wrapper">
            <label class="label" for="txt-nom"><?php echo _( 'Nom de page' ); ?></label>
            <input class="field" id="txt-nom" name="title" type="text">

        </div>
        <label class="label" for="txt-contenu"><?php echo _( 'Contenu de la page' ); ?></label><br/>
