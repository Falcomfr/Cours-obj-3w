            ...
            <header role="banner">
                ...
                <nav id="primary-nav">
                    <ul class="menus" id="primary-menu">
                        ...
                        <?php if( class_exists( 'PostsController' ) && $me->can( 'edit_pages' ) ) : ?><li class="menu-item<?php if( is_current_menu_item( get_app_info( 'url' ) . 'posts/list/' ) ) echo ' current-menu-item'; ?>"><a href="<?php app_info( 'url' ); ?>posts/list/" title="<?php echo _( 'Posts' ); ?>"><?php echo _( 'Posts' ); ?></a></li><?php endif; ?>
                        <?php if( class_exists( 'PortfolioController' ) && $me->can( 'edit_posts' ) ) : ?><li class="menu-item<?php if( is_current_menu_item( get_app_info( 'url' ) . 'portfolio/list/' ) ) echo ' current-menu-item'; ?>"><a href="<?php app_info( 'url' ); ?>portfolio/list/" title="<?php echo _( 'Portfolio' ); ?>"><?php echo _( 'Portfolio' ); ?></a></li><?php endif; ?>
